...
COLS = 100
ROWS = 53  # matched to the square 1024x1024 logo crop (100*8 : 53*15, ~1:1)
CELL_W = 8
CELL_H = 15
...
parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" '
             f'text-anchor="middle">hoophedge@github: ~$ ./logo.sh</text>')
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'
             f'hoophedge@github:~$ whoami <tspan fill="{INK}">hoophedge</tspan></text>')
parts.append(f'<rect x="{PAD+290}" y="{status_y-12:.1f}" width="8" height="14" fill="{INK}">'
